...
set_size = 128
continuous_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Saved Models/continuous end gradient non weighted mse 8/Model 11 (1).h5"
continuous_model = load_model(continuous_path,compile=False)
upsampling_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Saved Models/continuous end gradient upsampling 1/Model 61.h5"
upsampling_model = load_model(upsampling_path,compile=False)
...
for set_num in range(0,1):
    ...
    for n,midi in enumerate(midis):
        ...
        upsampled_graph = upsampling_model.predict(np.stack([np.stack([continuous_array],axis=2)]))
        upsampled_array = np.squeeze(upsampled_graph[0], axis=2)
        actual_midis.append(upsampled_array)
