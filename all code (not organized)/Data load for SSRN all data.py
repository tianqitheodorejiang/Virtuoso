...
slide_window = 512
in_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/all data"
pathes = []
for set_ in os.listdir(in_path):
    pathes.append(in_path+"/"+set_)

set_size = 20480000
save_folder_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/Midis and Mels for Machine Learning SSRN unshuffled quarter"
...
sets_ = []
start_index = 0
for set_num in range(0,len(pathes)-3):
    path = pathes[set_num]
    print(path)
    ###loading in spectrograms-----------------------------------------------------------
    
    y,sr = librosa.load(path+"/"+"instrument.wav")
