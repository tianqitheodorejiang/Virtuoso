    ...
    while True:
        ...
        for good in range(70,71):
            ...
            for i in range(70,130):
                test = skimage.transform.rescale(midi_specgram,((2*i/100),1))
                ...
                for t,thing in enumerate(test):
                    test[t,:] = np.mean(thing)
                for t,thing in enumerate(test_wav):
                    test_wav[t,:] = np.mean(thing)
