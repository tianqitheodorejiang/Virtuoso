...
def load_predicted(binary_path, continuous_path):
    ...
    ax.imshow(np.squeeze(array2,axis=2))
    plt.show()
...
continuous_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/test prediction spectrograms/MSE/32.h5"
binary_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/test prediction spectrograms/MSE/32_true.h5"
tru_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/test prediction spectrograms/MSE/32_true.h5"
...
scipy.io.wavfile.write(save_folder+"/pred.wav",22050,np.array(pred*32767, dtype=np.int16))
scipy.io.wavfile.write(save_folder+"/true.wav",22050,np.array(true*32767, dtype=np.int16))
