...
save_folder_path = "C:/Users/JiangQin/Documents/python/Music Composition Project/Music data/violin/Midis and Mels for Machine Learning mel2mel 256 time splithalf frame with gradient"
...
for set_num in range(0,len(pathes)):
    ...
    if len(wavs)!=len(midis):
        print("\n\n\nMIDIS AND WAVS DIFFERENT\n\n\n")
        input("bru")
    print("Loaded in" ,len(wavs),len(midis), "sets in", int((time.time() - start_time)/60), "minutes and",
